...
\usepackage{hyperxmp}
\hypersetup{
    pdfauthor={\copyright Nic Freeman, University of Sheffield \the\year.  All rights reserved.},
}
...
\HTMLDescription{MAS350 Probability with Measure, Sheffield University, Sept 2020.}% Sets the HTML meta description.
\HTMLFirstPageTop{MAS350}
\HTMLPageTop{}
\HTMLPageBottom{Copyright Nic Freeman, Sheffield University, n.p.freeman [at] sheffield.ac.uk}
...
\AtBeginShipout{\AtBeginShipoutUpperLeft{%
  \put(\dimexpr\paperwidth-0.2cm\relax,-0.5cm){\makebox[0pt][r]{\color{lightgrey}\textit{\copyright Nic Freeman, University of Sheffield \the\year.}}}%
}}
